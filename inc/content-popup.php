...
.paperplane-popup-rotate {
  -webkit-transition-delay: <?php echo $pop_up_timer_css; ?>s;
	transition-delay: <?php echo $pop_up_timer_css; ?>s;
}
</style>

<div id="cookie_box<?php echo $post_slug; ?>" class="def-popup-set unset-pointer-events <?php the_field('bordi_arrotondati'); ?> <?php echo $popup_overlay_class; ?> <?php echo $popup_verticalize; ?> popup-<?php echo $pop_up_position; ?>" style="background-color: <?php echo $colore_overlay; ?>;">
  <div class="popup-wrapper" style="max-width: <?php echo $larghezza_max_pop_up; ?>px; width: <?php echo $larghezza_min_pop_up; ?>px;">
    <?php if ( $show_close_button === 'si' ) : ?>
      <div class="popup-close-btn popup-close-<?php echo $close_button_shape; ?> popup-close-<?php echo $close_button_position; ?> cookie_box_close_forever<?php echo $post_slug; ?>">
    ...
    <?php endif; ?>
    <div class="popup-shape <?php the_field('bordi_arrotondati'); ?> <?php echo $shape_class; ?> <?php echo $shadow; ?>" style="min-height: <?php echo $min_height; ?>px">
