...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://www.paperplanefactory.com/plugins/plugin.json',
 ...
 function paperplanePopup_init() {
	 ...
	 if( class_exists( 'ACF' ) && class_exists( 'dhz_acf_plugin_extended_color_picker' )  ) {
		 ...
		 function paperplanepopup_scripts(){
			 // Cookies library
			 wp_register_script( 'paperplanepopup-general', plugins_url( '/js/js.cookie.min.js', __FILE__ ) );
			 wp_enqueue_script( 'paperplanepopup-general' );
		 }
		 // Styles
